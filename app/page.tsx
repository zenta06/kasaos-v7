    ...
    try {
      if (isLogin) {
        try {
          ...
          if (err.code === 'auth/multi-factor-auth-required') {
            ...
            const recaptchaVerifier = (window as any)
              .recaptchaVerifier;
        ...
        setSuccess(
          'Hesap oluşturuldu! Şimdi giriş yapın.'
        );
      }
    } catch (err: any) {
      console.error(err);
      ...
      setError(
        err.code === 'auth/user-not-found'
          ...
          : 'Kimlik bilgileri hatalı veya eksik.'
      );
    } finally {
      setLoading(false);
    }
            ...
            {!showMfa ? (
              ...
              >
                ...
                <div className="flex bg-black/40 p-1.5 rounded-3xl mb-8 relative">
                  <button
                    ...
                    className={`flex-1 py-3 text-[11px] font-black uppercase tracking-widest relative z-10 ${
                      isLogin
                        ? 'text-white'
                        : 'text-slate-500'
                    }`}
                  ...
                  <motion.div
                    className="absolute top-1.5 bottom-1.5 left-1.5 bg-blue-600 rounded-[1.2rem]"
                    animate={{
                      x: isLogin ? '0%' : '100%',
                      width: 'calc(50% - 3px)',
                    }}
                ...
                <div className="relative group">
                  <Mail
                    className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-blue-500"
                    size={20}
                  />
                  ...
                  <input
                    ...
                    className="w-full pl-14 pr-6 py-5 rounded-[1.8rem] bg-white/5 border border-white/10 text-white outline-none focus:border-blue-500/50 text-sm"
                  />
                </div>
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full py-5 bg-blue-600 text-white font-black text-xs uppercase tracking-[0.2em] rounded-[1.8rem] flex items-center justify-center gap-3 active:scale-95 transition-transform"
                >
                  {loading ? (
              ...
              >
                <button
                  ...
                  className="flex items-center gap-2 text-slate-500 hover:text-white transition-colors text-xs font-bold mb-4"
                >
                  <ArrowLeft size={16} />
                  Geri Dön
                </button>
                ...
                <div className="text-center space-y-2">
                  ...
                  <p className="text-slate-400 text-xs">
                    Telefonunuza gönderilen 6
                    haneli güvenlik kodunu girin.
                  </p>
                </div>
